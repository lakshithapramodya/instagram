    ...
    <div className="shadow-sm border-b bg-white sticky top-0 z-50">
      <div className="flex justify-between max-w-6xl mx-5 lg:mx-auto">
        ...
        {session ? (
          ...
          <Bars3Icon className="md:hidden h-6 cursor-pointer" /><div className="relative navBtn">
          ...
          />
        </div>) : (HomeIcon className="navBtn" />
          <Bars3Icon className="md:hidden h-6 cursor-pointer" /><div className="relative navBtn"></div>)</div>)}
